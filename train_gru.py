...
class GRUModel(nn.Module):
    def __init__(self, input_dim=4, hidden_size=128, num_layers=2, num_classes=14, dropout=0.3):
        super().__init__()
        self.gru = nn.GRU(input_dim, hidden_size, num_layers, batch_first=True, dropout=dropout if num_layers > 1 else 0)
...
def main():
    ...
    parser.add_argument("--save", type=str, default="checkpoints/gru.pt")
    ...
    with open("results_gru.txt", "w", encoding="utf-8") as f:
